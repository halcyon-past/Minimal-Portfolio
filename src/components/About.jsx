          ...
          <div className="md:w-1/2 text-gray-700 dark:text-gray-300 cursor-default">
            ...
            <div className="mt-16 flex flex-col md:flex-row gap-12">
              <motion.div variants={itemVariants} className="flex-1">
                <h3 className="text-2xl font-semibold mb-6 text-[var(--chrysler-blue)] border-b pb-2">Experience</h3>
              ...
              <motion.div variants={itemVariants} className="flex-1">
                <h3 className="text-2xl font-semibold mb-6 text-[var(--chrysler-blue)] border-b pb-2">Education</h3>
                <div className="space-y-6">
