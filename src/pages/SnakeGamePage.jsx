  ...
  return (
    <div className="relative max-w-2xl mx-auto px-4 py-8 md:py-12 min-h-[85vh] flex flex-col justify-start items-center font-sans">
      ...
      >
        ...
        <div 
          className="relative w-full max-w-[450px] mx-auto aspect-square bg-gray-50 border-2 border-gray-200 rounded-lg overflow-hidden touch-none"
        ...
        >
          ...
          {status === 'dying' && (
            <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-4 text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 drop-shadow-sm">Game Over!</h2>
            </div>
          )}
        ...
        {/* Mobile controls */}
        <div className="md:hidden relative w-48 h-48 mx-auto mt-6 bg-gray-100 rounded-full shadow-inner border border-gray-200">
          <button 
            className="absolute top-2 left-1/2 -translate-x-1/2 w-14 h-14 bg-white rounded-full shadow-md hover:bg-gray-50 active:scale-90 active:bg-gray-200 transition-all flex items-center justify-center text-gray-700" 
          ...
          <button 
            className="absolute bottom-2 left-1/2 -translate-x-1/2 w-14 h-14 bg-white rounded-full shadow-md hover:bg-gray-50 active:scale-90 active:bg-gray-200 transition-all flex items-center justify-center text-gray-700" 
            onClick={() => changeDirection({ x: 0, y: 1 })}
          >
          ...
          <button 
            className="absolute left-2 top-1/2 -translate-y-1/2 w-14 h-14 bg-white rounded-full shadow-md hover:bg-gray-50 active:scale-90 active:bg-gray-200 transition-all flex items-center justify-center text-gray-700" 
          ...
          <button 
            className="absolute right-2 top-1/2 -translate-y-1/2 w-14 h-14 bg-white rounded-full shadow-md hover:bg-gray-50 active:scale-90 active:bg-gray-200 transition-all flex items-center justify-center text-gray-700" 
            onClick={() => changeDirection({ x: 1, y: 0 })}
          >
